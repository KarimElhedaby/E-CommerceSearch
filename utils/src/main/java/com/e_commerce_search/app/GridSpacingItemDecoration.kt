package  com.e_commerce_search.app
...
public class GridSpacingItemDecoration(
    var spanCount: Int, var spacing: Int,
    var includeEdge: Boolean, var headerNum: Int
...
class LinearSpacingItemDecoration(
    var spacing: Int, var includeEdge: Boolean,
    var headerNum: Int
) : RecyclerView.ItemDecoration() {
    ...
    override fun getItemOffsets(outRect: Rect, view: View, parent: RecyclerView, state: RecyclerView.State) {
        ...
        if (position >= 0) {
            ...
            if (includeEdge) {
                ...
                outRect.right =
                    spacing - (column + 1) * spacing // spacing - (column + 1) * ((1f /    spanCount) * spacing)
